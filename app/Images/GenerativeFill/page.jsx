...
const Dashboard = () => {
  ...
  const handleTransform = async (e) => {
    ...
    try {
      setLoadIcon(true)
      const response = await axios.post(
        "https://claudcanvas-backend.onrender.com/api/v1/media/Process/Image/GenerativeFill/",
        formData,
        {
          headers: {
    ...
    <div className="flex flex-1 overflow-y-scroll">
      <div className="flex h-full w-full flex-1 flex-col gap-4 rounded-tl-2xl border border-neutral-200 bg-gradient-to-br p-6  dark:from-neutral-800 dark:to-neutral-900 dark:border-neutral-700">
        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight  text-center">
          Fill your Background with ease
        </h1>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <option value="4:5">Instagram Potrait [4:5]</option>
                <option value="16:9">Twitter Post(X.com) [16:9]</option>
                <option value="3:1">Twitter Header(X.com) [3:1]</option>
                <option value="3:1">Facebook Cover [3:1]</option>
              </select>
            </div>
            <div>

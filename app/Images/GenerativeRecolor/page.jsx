...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-1 overflow-y-scroll">
      <div className="flex h-full w-full flex-1 flex-col gap-4 rounded-tl-2xl   bg-gradient-to-br p-6 dark:from-neutral-800 dark:to-neutral-900 dark:border-neutral-700">
        ...
        <div>
          <form action="" className="w-[90%] mx-auto my-5 shadow rounded-xl p-3">
            ...
            <div>
              <label htmlFor="" className="text-2xl">Item to Recolor:</label>
              <br />
              <input type="text" name="" id="" className="border-2 border-neutral-200 my-2 rounded-lg p-3 w-full" placeholder="Create A Title" />
            </div>
            <div>
        ...
        <div className="mt-6 py-5">
          ...
          <div className="flex justify-center gap-4 mt-4 flex-wrap">
            {[
              ...
              "#FF8C00", "#FFD700", "#ADFF2F", "#00FA9A", "#00CED1", "#1E90FF",
              "#9370DB", "#FF69B4", "#FF1493", "#FF4500", "#2E8B57", "#4682B4"
            ].map((color, index) => (
              <div
                key={index}
